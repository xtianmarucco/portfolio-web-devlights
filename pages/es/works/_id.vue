      ...
      <div style="position:relative;" id="livetsection1">
        <v-layout row wrap align-center justify-center class="mt-15">
          ...
          >
            ...
            <h1 class="livettext">{{work.client.livetAboutTitleEs}}</h1>

            <h2 class="livettext" style="margin-top:25px;">{{work.client.livetAboutSubEs}}</h2>
          </v-flex>
      ...
      <v-container grid-list-xl style="margin-top:350px;">
        <v-layout row wrap>
          <v-flex v-for="item in work.urlImages.mobileSas" :key="item">
            <img style="margin-top:100px;" :src="item" alt />
          </v-flex>
          ...
          <v-flex xs12 md10 align-center justify-center>
            <v-layout row wrap style="margin-top:200px;  margin-bottom:-400px;">
              <v-flex md4 xs12 align-center justify-self-center class="text-xs-center">
                <h2 text-xs-center>{{ work.client.txtCeoEs1 }}</h2>
                <v-img style="transform:scale(.6);" :src="work.urlImages.ceoImg1" alt />
              </v-flex>

              <v-flex md4 xs12 align-center justify-self-center class="text-xs-center">
                <h2 pl-5 pr-5 text-xs-center>{{ work.client.txtCeoEs2 }}</h2>
                <v-img style="transform:scale(.6);" :src="work.urlImages.ceoImg2" alt />
              </v-flex>

              <v-flex md4 xs12 align-center justify-self-center class="text-xs-center">
                <h2 text-xs-center>{{ work.client.txtCeoEs3 }}</h2>
      ...
      <v-container grid-list-xl>
        <v-layout row wrap>
          ...
          >
            ...
            <!-- <v-flex>
              <img src alt />
              <h2 style="padding-top:25px;" text-xs-center>{{ work.client.es.txtOcioEs4 }}</h2>
              <img src alt />
              <h2 style="padding-top:25px" text-xs-center>{{ work.client.es.txtOcioEs2}}</h2>
              <img src alt />
              <h2 style="padding-top:25px" text-xs-center>{{ work.client.es.txtOcioEs3 }}</h2>
              <img src alt />
              <h2 style="padding-top:25px" text-xs-center>{{ work.client.txtOcioEs1 }}</h2>
            </v-flex>-->
            <v-container>
      ...
      <v-container style="margin-top:-250px;">
        <v-layout row wrap>
          <v-flex data-aos="fade-right" md6 xs12 align-center justify-self-center>
            ...
            <v-flex ml-5 mr-5>
              <h2 style="padding-top:25px;" text-xs-center>{{ work.client.txtBoxEs1 }}</h2>
              <h2 style="padding-top:25px" text-xs-center>{{ work.client.txtBoxEs2 }}</h2>
              <h2 style="padding-top:25px" text-xs-center>{{ work.client.txtBoxEs3}}</h2>
              <h2 style="padding-top:25px" text-xs-center>{{ work.client.txtBoxEs4 }}</h2>
            </v-flex>
